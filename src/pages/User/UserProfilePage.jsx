            ...
            <Card className="border border-gray-200">
              <CardHeader className="border-b border-gray-200 bg-white">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <CardTitle className="text-xl text-gray-900">{userData.name}</CardTitle>
                ...
                <div className="grid gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        <Badge variant={getRoleVariant(userData.role)} className="font-medium">
                          {userData.role}
                        </Badge>
                      </div>
                    </div>
          ...
          <Card className="border border-gray-200">
            <CardHeader className="border-b border-gray-200 pb-3">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-lg text-gray-900">Ticket Purchase History</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="p-6">
              <div className="text-center text-gray-500 py-8">
                ...
                <p className="text-xs text-gray-400 mt-1">Purchase history will appear here</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-gray-200">
            <CardHeader className="border-b border-gray-200 pb-3">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-lg text-gray-900">Running Events</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="p-6">
              <div className="text-center text-gray-500 py-8">
                ...
                <p className="text-xs text-gray-400 mt-1">Active events will appear here</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="border border-gray-200">
          ...
          <CardContent className="p-6">
            <div className="text-center text-gray-500 py-8">
              ...
              <p className="text-xs text-gray-400 mt-1">User activity timeline will appear here</p>
            </div>
          </CardContent>
        </Card>
