...
const AuthPages = () => {
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert(`${currentView === 'login' ? 'Login' : 'Registration'} successful!`);
      // Reset form
      setFormData({
        name: '',
        email: '',
  ...
  0 1.326v21.348C0 23.403.597 24 1.326 24H12.82v-9.294H9.692v-3.622h3.128V8.413
  ...
  0 1.326-.597 1.326-1.326V1.326C24 
