  ...
  const featuredEvents = [
    {
      ...
      rating: 4.9,
      image:
        "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800&h=400&fit=crop&crop=center",
    ...
    },
    {
      ...
      rating: 4.7,
      image:
        "https://images.unsplash.com/photo-1507924538820-ede94a04019d?w=800&h=400&fit=crop&crop=center",
                      ...
                      >
                        <div className="flex flex-col lg:flex-row h-full">
                          ...
                          <div className="lg:w-2/3 relative overflow-hidden">
                            ...
                            />
                            <div
                              className={`absolute inset-0 bg-gradient-to-r ${event.gradient} opacity-20`}
                            ></div>
                          </div>
